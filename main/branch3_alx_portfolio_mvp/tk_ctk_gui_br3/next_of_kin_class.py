...
import re
from next_of_kin_data_collector_func import next_of_kin_data_collector
        ...
        def ignitor():
            ...
            try:
              if NoK_data_entry_cntrlcheck(first_name, middle_name, last_name, country, state, town_county, address, phone_number, email, profession, position, company, industry):
                  next_of_kin_data_collector(first_name, middle_name, last_name, address, phone_number, email, day, month, year, profession, position, company, industry)
