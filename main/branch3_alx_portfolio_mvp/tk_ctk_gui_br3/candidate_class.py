...
from candidate_data_collector_func import candidate_data_collector
...
class Candidate_page(tk.Frame):
    def __init__(self, parent, controller):
        ...
        def ignitor():
            ...
            try:
                if cddt_entry_data_cntrl_checker(candidate_number, candidate_seat_number, first_name, middle_name, last_name, country, state, town_county, phone_number, email):
                    candidate_data_collector(first_name, middle_name, last_name, address, phone_number, email, day, month, year, candidate_number, candidate_seat_number)
